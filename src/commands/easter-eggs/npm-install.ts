...
export function npmInstall(): Line[] {
  return [
    ...
    {
      text: 'npm http fetch GET 200 https://registry.npmjs.org/lodash',
      delayMs: 320,
      style: 'dim',
    },
    { text: 'npm http fetch GET 200 https://registry.npmjs.org/chalk', delayMs: 320, style: 'dim' },
    {
      text: 'npm http fetch GET 200 https://registry.npmjs.org/typescript',
      delayMs: 320,
      style: 'dim',
    },
    {
      text: 'npm http fetch GET 200 https://registry.npmjs.org/webpack',
      delayMs: 320,
      style: 'dim',
    },
    { text: '\u00A0', delayMs: 700 },
